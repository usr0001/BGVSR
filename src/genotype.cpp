...
void genotype::read_txt_naive_micro(std::string filename,bool allow_missing,Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> &geno_matrix)
{
